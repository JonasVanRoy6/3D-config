...
function Picker() {
  ...
  return (
    <div className=" flex flex-col md:flex-col   gap-4 md:gap-8  justify-center items-center  bg-gray-100 rounded-xl">
      ...
      <h1 className="text-1xl md:text-1xl font-extralight capitalize select-none	">
        {snap.current ? snap.current : "Kies een gedeelte"}
      </h1>
    </div>
  );
}
...
export default function App() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center  items-center w-screen h-screen bg-gray-100 overflow-x-hidden">
      ...
      <div className=" flex flex-col justify-evenly items-center  w-screen md:w-[380px]  h-[50vh] md:h-screen  p-2 px-8 gap-2 md:gap-0 md:p-8  bg-gray-100 overflow-y-visible 	 ">
        <div className="flex justify-center items-center gap-4">
          <h2 className=" text-3xl md:text-2xl font-small pointer-events-none select-none	  ">
            Kies een kleur en duid aan waar je die wilt gebruiken.
          </h2>
        ...
        <button
          className=" m-2 md:m-4 p-2 md:p-5 px-4 md:px-8 shadow-lg rounded-full  border text-sm md:text-1xl select-none	"
          onClick={() => {
